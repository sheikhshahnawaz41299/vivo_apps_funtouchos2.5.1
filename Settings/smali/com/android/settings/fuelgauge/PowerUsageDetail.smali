...
.method private createDetails()V
    ...
    check-cast v11, Lcom/android/internal/os/BatterySipper$DrainType;

    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mDrainType:Lcom/android/internal/os/BatterySipper$DrainType;
    ...
    iput-wide v12, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mNoCoverage:D
    ...
    .line 370
    .local v5, "iconId":I
    const-string v11, "showLocationButton"

    invoke-virtual {v1, v11}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v11

    iput-boolean v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mShowLocationButton:Z
    ...
    invoke-virtual {v8, v6, v11}, Landroid/content/pm/PackageManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mTitleView:Landroid/widget/TextView;
    ...
    .line 400
    .local v10, "text1":Landroid/widget/TextView;
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mTwoButtonsPanel:Landroid/view/ViewGroup;

    .line 403
    iget-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mRootView:Landroid/view/View;

    const v12, 0x7f0e0238
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mForceStopButton:Landroid/widget/Button;

    .line 404
    iget-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mRootView:Landroid/view/View;

    const v12, 0x7f0e0239
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mReportButton:Landroid/widget/Button;
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mDetailsParent:Landroid/view/ViewGroup;

    .line 414
    iget-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mRootView:Landroid/view/View;

    const v12, 0x7f0e0179
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mControlsParent:Landroid/view/ViewGroup;

    .line 415
    iget-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mRootView:Landroid/view/View;

    const v12, 0x7f0e017b
    ...
    iput-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mMessagesParent:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, v11}, Lcom/android/settings/fuelgauge/PowerUsageDetail;->fillMessagesSection(I)V
    ...
    :cond_2
    :goto_1
    iget-object v12, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mReportButton:Landroid/widget/Button;

    iget-object v11, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mInstaller:Landroid/content/ComponentName;
    ...
    .end local v9    # "summary":Landroid/widget/TextView;
    .end local v10    # "text1":Landroid/widget/TextView;
    :cond_3
    if-eqz v5, :cond_0
    ...
    invoke-virtual {v11, v5}, Landroid/app/Activity;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    .restart local v9    # "summary":Landroid/widget/TextView;
    .restart local v10    # "text1":Landroid/widget/TextView;
    :cond_4
    const/4 v11, 0x0
