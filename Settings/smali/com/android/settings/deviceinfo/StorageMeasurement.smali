...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->mStorageManagerWrapper:Lcom/vivo/settings/StorageManagerWrapper;
...
.method static synthetic access$700()Lcom/vivo/settings/StorageManagerWrapper;
    .locals 1

    .prologue
    .line 65
    sget-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->mStorageManagerWrapper:Lcom/vivo/settings/StorageManagerWrapper;
...
.method public static getInstance(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/settings/deviceinfo/StorageMeasurement;
    ...
    .prologue
    .line 93
    sget-object v3, Lcom/android/settings/deviceinfo/StorageMeasurement;->sInstances:Ljava/util/HashMap;
    ...
    .line 95
    .local v1, "value":Lcom/android/settings/deviceinfo/StorageMeasurement;
    if-nez v1, :cond_0

    .line 96
    new-instance v1, Lcom/android/settings/deviceinfo/StorageMeasurement;

    .end local v1    # "value":Lcom/android/settings/deviceinfo/StorageMeasurement;
    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2, p1}, Lcom/android/settings/deviceinfo/StorageMeasurement;-><init>(Landroid/content/Context;Landroid/os/storage/StorageVolume;)V

    .line 97
    .restart local v1    # "value":Lcom/android/settings/deviceinfo/StorageMeasurement;
    sget-object v2, Lcom/android/settings/deviceinfo/StorageMeasurement;->sInstances:Ljava/util/HashMap;
    ...
    .line 100
    :cond_0
    sget-object v2, Lcom/android/settings/deviceinfo/StorageMeasurement;->mStorageManagerWrapper:Lcom/vivo/settings/StorageManagerWrapper;
    ...
    const-string v4, "getInstance Failed to get StorageManager"

    invoke-static {v2, v4}, Lcom/vivo/settings/Vlog;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object v2, Lcom/android/settings/deviceinfo/StorageMeasurement;->mStorageManagerWrapper:Lcom/vivo/settings/StorageManagerWrapper;
...
.method private measureMisc(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    const-string v9, "measureMisc path:"
    ...
    invoke-static {v2, v8}, Lcom/vivo/settings/Vlog;->d(Ljava/lang/String;Ljava/lang/String;)V
