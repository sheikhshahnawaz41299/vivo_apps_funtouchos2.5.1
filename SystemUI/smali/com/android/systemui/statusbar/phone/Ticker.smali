...
.method public addEntry(Landroid/service/notification/StatusBarNotification;)V
    ...
    iget-object v3, v0, Lcom/android/systemui/statusbar/phone/Ticker;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v3, v4}, Lcom/android/systemui/vivo/common/notification/NotificationOpsManager;->isAppLockedByIManager(Ljava/lang/String;)Z

    move-result v14

    .line 212
    .local v14, "isAppLocked":Z
    if-eqz v14, :cond_4
    ...
    invoke-direct {v15, v0, v1, v12, v2}, Lcom/android/systemui/statusbar/phone/Ticker$Segment;-><init>(Lcom/android/systemui/statusbar/phone/Ticker;Landroid/service/notification/StatusBarNotification;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;)V
    ...
    .line 215
    .end local v10    # "i":I
    .end local v15    # "newSegment":Lcom/android/systemui/statusbar/phone/Ticker$Segment;
    .end local v16    # "seg":Lcom/android/systemui/statusbar/phone/Ticker$Segment;
    ...
    .line 229
    .restart local v10    # "i":I
    .restart local v15    # "newSegment":Lcom/android/systemui/statusbar/phone/Ticker$Segment;
    :cond_5
    move-object/from16 v0, p0
