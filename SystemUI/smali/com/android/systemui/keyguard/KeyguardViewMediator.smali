...
# static fields
.field private static final ACTION_GLOBAL_THEME_CHANGED:Ljava/lang/String; = "intent.action.theme.changed"
...
.field private static final KEYGUARD_LOCK_SOUND:Ljava/lang/String; = "/data/bbkcore/theme/ringtones/lock.mp3"

.field private static final KEYGUARD_TIMEOUT:I = 0xd

.field private static final KEYGUARD_UNLOCK_SOUND:Ljava/lang/String; = "/data/bbkcore/theme/ringtones/unlock.mp3"

.field private static final MSG_GLOBAL_THEME_CHANGED:I = 0x66

.field private static final NOTIFY_SCREEN_OFF:I = 0x6

.field private static final NOTIFY_SCREEN_ON:I = 0x7

.field private static final OFF_BECAUSE_OF_PROX_SENSOR:I = 0x4
...
.method static synthetic access$1200(Lcom/android/systemui/keyguard/KeyguardViewMediator;Landroid/os/Bundle;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/systemui/keyguard/KeyguardViewMediator;
...
.method private adjustStatusBarLocked()V
    ...
    const-string v3, "StatusBarManager.disable() failed!!"
...
.method private doKeyguardLaterLocked()V
    ...
    const-string v17, "setting alarm to turn off keyguard, seq = "
...
.method private doKeyguardLocked(Landroid/os/Bundle;)V
    ...
    invoke-static {v5}, Lcom/android/systemui/vivo/common/keyguard/KeyguardStateManager;->getInstance(Landroid/content/Context;)Lcom/android/systemui/vivo/common/keyguard/KeyguardStateManager;

    move-result-object v5

    invoke-virtual {v5}, Lcom/android/systemui/vivo/common/keyguard/KeyguardStateManager;->shouldShowWindow()Z
    ...
    .line 1047
    .local v3, "subId":I
    invoke-direct {p0, v3, v2}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->isSimLockedOrMissing(IZ)Z
...
.method private handleKeyguardDone(ZZ)V
    ...
    .line 1284
    const-string v2, "sys.fingerprint.keguard"
    ...
    const-string v4, "handleKeyguardDone fingerPrintDismiss = "
    ...
    invoke-virtual {v2, v1, v5, v5}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->unlockFromFingerprint(IZI)V
...
.method private handleStartKeyguardExitAnimation(JJ)V
    ...
    .end local v0    # "smartwakeDismiss":I
    :catchall_0
    move-exception v1
...
.method private playSounds(Z)V
    ...
    .line 1365
    :cond_0
    const-string v1, "persist.sys.factory.mode"
    ...
    .line 1366
    .local v0, "factoryModeActivate":Ljava/lang/String;
    const-string v1, "yes"
    ...
    const-string v2, "FactoryMode should not play lock/unlock sound"
    ...
    :goto_1
    invoke-direct {p0, v1}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->playSound(I)V

    goto :goto_0

    :cond_2
    iget v1, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mUnlockSoundId:I
...
.method private sendKeyguardStateChangedBroadcast(Z)V
    .locals 9
    .param p1, "showing"    # Z
    ...
    const-string v8, "send keyguard state changed broadcast, showing: "
    ...
    const-string v7, "com.vivo.action.KEYGUARD_STATE_CHANGED"
    ...
    .line 1749
    .local v5, "userHandles":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/UserInfo;>;"
    ...
    .end local v5    # "userHandles":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/UserInfo;>;"
    :catchall_0
    move-exception v6
...
.method private setupLocked()V
    ...
    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mPM:Landroid/os/PowerManager;
    ...
    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mWM:Landroid/view/IWindowManager;
    ...
    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mTrustManager:Landroid/app/trust/TrustManager;

    .line 569
    iget-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mPM:Landroid/os/PowerManager;

    const-string v5, "show keyguard"

    invoke-virtual {v2, v3, v5}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v2

    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mShowKeyguardWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-direct {v2, v5}, Lcom/android/keyguard/KeyguardDisplayManager;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mKeyguardDisplayManager:Lcom/android/keyguard/KeyguardDisplayManager;
    ...
    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-virtual {v2, v5}, Lcom/android/internal/widget/LockPatternUtils;->setCurrentUser(I)V
    ...
    invoke-direct {v2, v3, v4, v5}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;-><init>(Landroid/content/Context;Lcom/android/keyguard/ViewMediatorCallback;Lcom/android/internal/widget/LockPatternUtils;)V

    iput-object v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mStatusBarKeyguardViewManager:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;
    ...
    .line 602
    invoke-virtual {p0}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->updateKeyguardSounds()V
...
.method private updateActivityLockScreenState()V
    ...
    :goto_0
    invoke-interface {v3, v2}, Landroid/app/IActivityManager;->setLockScreenShown(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_2
    invoke-direct {p0, v0}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->sendKeyguardStateChangedBroadcast(Z)V
...
.method public hideKeyguardByFingerprint(I)V
    ...
    const-string v3, "hideKeyguardByFingerprint, hide = "
    ...
    :goto_1
    invoke-virtual {v1, v0}, Lcom/android/systemui/vivo/common/keyguard/KeyguardStateManager;->setHideFromFingerprint(Z)V
...
.method public onActivityDrawn()V
    ...
    const-string v1, "on activity drawn"
...
.method public onScreenTurnedOff(I)V
    ...
    const-string v3, "on screen turned off, and keyguard is hiding , stop hiding and locked"
    ...
    const-string v3, "on screen turned off, we should show keyguard immediately, because it doesn\'t destroyed"
    ...
    const-string v3, "OFF_BECAUSE_OF_PROX_SENSOR, ignore"
...
.method public setOccluded(Z)V
    ...
    const-string v4, "setOccluded, mOccluded = "
...
.method public updateKeyguardSounds()V
    .locals 6
    ...
    .line 1698
    const-string v1, "/data/bbkcore/theme/ringtones/lock.mp3"

    .line 1699
    .local v1, "soundPath":Ljava/lang/String;
    invoke-direct {p0, v1}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->isFileExist(Ljava/lang/String;)Z
    ...
    iput v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mLockSoundId:I
    ...
    .line 1708
    :cond_3
    const-string v1, "/data/bbkcore/theme/ringtones/unlock.mp3"
    ...
    iput v2, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mUnlockSoundId:I
